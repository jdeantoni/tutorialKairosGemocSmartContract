...
public class SimplelanguageCodeExecutor extends CodeExecutorDispatcher 
	...
	public SimplelanguageCodeExecutor(){
		...
		addExecutor(new org.eclipse.gemoc.execution.concurrent.ccsljavaengine.extensions.k3.dsa.impl.K3DSLCodeExecutor(this,
			"fr.inria.kairos.tuto.simplelanguage.Simplelanguage"));
