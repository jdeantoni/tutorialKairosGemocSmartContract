...
package simplelanguage.xdsml.api.impl;
...
public class SimplelanguageRTDAccessor {
  public static fr.inria.kairos.tuto.simplelanguage.State getcurrentState(EObject eObject) {
		return ((fr.inria.kairos.tuto.simplelanguage.State)  getAspectProperty(eObject, "fr.inria.kairos.tuto.simplelanguage.Simplelanguage", "fr.inria.kairos.tuto.simplelanguage.semantics.rewritingrules.SmartContractAspect", "currentState"));
	}
	public static boolean setcurrentState(EObject eObject, fr.inria.kairos.tuto.simplelanguage.State newValue) {
		return setAspectProperty(eObject, "fr.inria.kairos.tuto.simplelanguage.Simplelanguage", "fr.inria.kairos.tuto.simplelanguage.semantics.rewritingrules.SmartContractAspect", "currentState", newValue);
	}
