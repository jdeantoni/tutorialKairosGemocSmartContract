package fr.inria.kairos.tuto.simplelanguage.design.services;
...
public class SmartcontractAnimationServices extends AbstractGemocAnimatorServices {
	...
	protected List<StringCouple> getRepresentationRefreshList() {
		...
		res.add(new StringCouple("SmartContract", "Animation"));
