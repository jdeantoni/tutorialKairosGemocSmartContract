...
/**
 * This is the item provider adapter for a {@link fr.inria.kairos.tuto.simplelanguage.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends NamedElementItemProvider {
	...
	protected void addTargetStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_targetState_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_targetState_feature",
								"_UI_Event_type"),
						SimplelanguagePackage.Literals.EVENT__TARGET_STATE, true, false, true, null, null, null));
	}
	...
	protected void addSourceStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Event_sourceState_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Event_sourceState_feature",
								"_UI_Event_type"),
						SimplelanguagePackage.Literals.EVENT__SOURCE_STATE, true, false, true, null, null, null));
	}
